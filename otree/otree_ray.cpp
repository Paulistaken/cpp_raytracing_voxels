...
namespace OCTTree::OCTRay {
    ...
    fn translate_ray(const OctTree& tree, const Vec3& oorgin, const Vec3& dir) -> std::optional<Vec3>{
    ...
    fn OCTRay::cpu_send_ray(const OctTree& tree, const std::optional<OCTRayOptions>& opt) const -> std::optional<RayResult>{
